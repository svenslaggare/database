...
std::unique_ptr<DatabaseEngine> setupJoinTest(std::vector<std::vector<QueryValue>>& tableData1,
											  std::vector<std::vector<QueryValue>>& tableData2,
											  std::initializer_list<std::string> indices1 = {},
											  std::initializer_list<std::string> indices2 = {},
											  std::int32_t count1 = 1000,
											  std::int32_t count2 = 1000) {
	Schema table1Schema(
		"test_table1",
		{
...
//			std::cout << std::endl;
	...
	void testSimple2() {
		...
		auto query = createQuery(std::make_unique<QuerySelectOperation>(
			...
			std::unique_ptr<QueryExpression>(),
			JoinClause("test_table1.i", "test_table2", "i"),
			OrderingClause({
				OrderingColumn{ "test_table1.i", false },
				OrderingColumn{ "test_table2.i", false },
			})
...
//			std::cout << std::endl;
	...
	void testFiltering1() {
		...
		auto query = createQuery(std::make_unique<QuerySelectOperation>(
			...
			std::make_unique<QueryCompareExpression>(
				std::make_unique<QueryColumnReferenceExpression>("test_table2.i"),
	...
	void testIndexing1() {
		std::vector<std::vector<QueryValue>> tableData1;
		std::vector<std::vector<QueryValue>> tableData2;
		auto databaseEngine = setupJoinTest(tableData1, tableData2, { "i" }, {});
...
//			std::cout << std::endl;
	...
	void testIndexing2() {
		std::vector<std::vector<QueryValue>> tableData1;
		std::vector<std::vector<QueryValue>> tableData2;
		auto databaseEngine = setupJoinTest(tableData1, tableData2, { "z" });
...
//			std::cout << std::endl;
	...
	void testIndexing4() {
		std::vector<std::vector<QueryValue>> tableData1;
		std::vector<std::vector<QueryValue>> tableData2;
		auto databaseEngine = setupJoinTest(tableData1, tableData2, {}, { "x" });
